        ...
        <div className="flex flex-col gap-16 max-w-screen-md m-auto pt-8 pb-24 px-4 animate-appears font-inter">
            ...
            <div className="flex flex-col space-y-6">
                ...
                <span className="text-zinc-500 text-justify">
                    Caso tenha gostado do que viu nos meus trabalhos, fique a
                    vontade para enviar um e-mail, seja ele como um feedback
                    para meus projetos ou caso tenha tido interesse no meu
                    trabalho. Ficarei super feliz em receber sua mensagem.
                </span>
