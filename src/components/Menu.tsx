  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="w-3/4 h-2/4 fixed m-auto inset-0 bg-zinc-200 animate-appears z-20 lg:w-[500px] lg:h-[300px] p-2 shadow-md rounded-md border border-zinc-300">
